# app/repositories/satellite_document_metadata_repository.py
...
from app.domain.warehouse import SatelliteDocumentMetadata


class FileSatelliteDocumentMetadataRepository:
    def __init__(
        self,
        storage_path: str = "data/warehouse/satellites/satellite_document_metadata.json",
    ) -> None:
    ...
    def _write_all(self, satellites: list[SatelliteDocumentMetadata]) -> None:
    ...
    def _to_dict(self, item: SatelliteDocumentMetadata) -> dict:
        return {
    ...
    def _from_dict(self, data: dict) -> SatelliteDocumentMetadata:
        return SatelliteDocumentMetadata(
